...
function ProductForm() {
    ...
    return ( 
        <form 
            ...
            <div className="space-y-12 bg-white p-7 rounded-lg">
                <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-base font-semibold leading-7 text-gray-900">Add new product details</h2>
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div className="mt-2">
                        <select className='w-full rounded-md' {...register('brand',{
                    ...
                    <div className="mt-2">
                        <select className='w-full rounded-md' {...register('category',{
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
                ...
                className={`rounded-md ${product.deleted? 'bg-green-600 hover:bg-green-500 focus-visible:outline-green-600':'bg-red-600 hover:bg-red-500 focus-visible:outline-red-600'} px-3 py-2 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2`}
                >
