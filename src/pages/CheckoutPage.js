...
const addresses=[
    {
        name:"Bhaawan Shrivastav",
        street:"210/10, Pandav road",
        city:"Delhi",
        pincode:110032,
        state:"Delhi",
        phone:9205092724
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ml-3 mr-3">
                    <div class="lg:col-span-3">
                        <form action="" class="py-4 bg-white rounded-md my-3 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="space-y-12">
                                ...
                                {addresses.map((address) => (
                                    <li key={address.email} className="flex justify-between gap-x-6 p-5 my-2 border-none bg-slate-200 rounded-xl">
                                    <div className="flex min-w-0 gap-x-4">
                                        <input
                                            name="address"
                                            type="radio"
                                            className="h-4 w-4 border-gray-300 text-indigo-500 focus:ring-transparent"
                                        />
                                        <div className="min-w-0 flex-auto">
                                        <p className="text-sm font-semibold leading-6 text-gray-900">{address.name}</p>
                                        <p className="mt-1 truncate text-xs leading-5 text-gray-600">{address.street}</p>
                                        <p className="mt-1 truncate text-xs leading-5 text-gray-600">{address.city}</p>
                                ...
                                <ul role="list" className="-my-6 divide-y divide-gray-200">
                                    ...
                                    <li key={product.id} className="flex py-6">
                                        ...
                                        <div className="flex flex-1 items-end justify-between text-sm">
                                            ...
                                            <select class="ml-3 rounded-lg bg-zinc-200 border-none">
